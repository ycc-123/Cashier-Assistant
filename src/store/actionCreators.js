import {
  SAVE_GOODS, SAVE_UNIACID, SAVE_MODE, SAVE_APP_CONFIG, SAVE_DEFAULT_ADDRESS, SAVE_SUBMIT_STORE,
...
// 保存提交页地址
export const saveSubmitStoreAction = data => ({
  type: SAVE_SUBMIT_STORE,
  data
})
...
export const saveSubmitStore = data => {
  return dispatch => {
    const action = saveSubmitStoreAction(data) 
    dispatch(action)
  }
}
